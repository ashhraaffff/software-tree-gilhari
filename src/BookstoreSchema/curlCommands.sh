...
curl -X POST "http://localhost:80/gilhari/v1/Book"  -H 'Content-Type: application/json' -d '{"entity":{"bookid":1,"bookname":"Hobbit","author":"Tolkien","description":"The story of hobbit","price":300,"release_date":381484800390}}' >> curl.log
echo -e "" >> curl.log
...
curl -X POST "http://localhost:80/gilhari/v1/Book"  -H 'Content-Type: application/json' -d '{"entity":{"bookid":2,"bookname":"Hobbit2","author":"Tolkien2","description":"The story of hobbit2","price":400,"release_date":381484890390}}' >> curl.log
echo "" >> curl.log
...
curl -X GET   "http://localhost:80/gilhari/v1/Book?filter=exempt=0"  -H 'Content-Type: application/json' >> curl.log
echo "" >> curl.log

echo "** Query the count of exempted Bookobjects" >> curl.log
curl -X GET   "http://localhost:80/gilhari/v1/Book/getAggregate?attribute=id&aggregateType=COUNT&filter=exempt=1"  -H 'Content-Type: application/json' >> curl.log
echo "" >> curl.log
